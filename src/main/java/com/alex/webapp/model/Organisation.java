...
public class Organisation {
    ...
    public static class Position {
        ...
        public Position(int startYear, Month startMonth, int endYear, Month entMonth, String title, String description) {
            this(DateUtil.of(startYear, startMonth), DateUtil.of(endYear, entMonth), title, description);
        }
